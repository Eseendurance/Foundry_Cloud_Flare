...
import { ArrowLeft, Mail, Search, Send, AlertCircle, CheckCircle2, XCircle } from "lucide-react";
    ...
    <div className="min-h-screen bg-paper">
      ...
      <main className="mx-auto max-w-4xl px-6 py-12">
        ...
        <p className="mt-2 max-w-xl text-sm text-ink-soft">
          Sends over a real SMTP account you connect, and checks a domain&apos;s
          real SPF and DMARC records over live DNS — no API key needed for
          the checker.
        </p>
        ...
        <div className="mt-10 grid gap-10 lg:grid-cols-2">
          ...
          <section className="rounded-2xl border border-line p-6">
            <div className="flex items-center gap-2">
              ...
              <h2 className="font-medium text-ink">Send a test email</h2>
            </div>
