...
const pillars = [
  {
    icon: Sparkles,
    name: "AI app builder",
    desc: "Describe what you want. Claude streams back a real, working single-page app you can preview, edit, and keep. Multi-file React projects are next.",
  },
  {
    icon: Code2,
    name: "In-browser IDE",
  ...
  },
  {
    ...
    desc: "Send real email through your own SMTP account, and check any domain's live SPF/DMARC setup — no key needed for the checker.",
  },
  {
    icon: Globe,
    name: "Domain lookup",
