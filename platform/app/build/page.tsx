    ...
    <div className="flex min-h-screen flex-col bg-paper">
      ...
      <main className="mx-auto flex w-full max-w-6xl flex-1 flex-col px-6 py-10">
        ...
        <p className="mt-2 max-w-2xl text-sm text-ink-soft">
          ...
          Claude, Gemini, or DeepSeek live, whichever you&apos;ve
          connected. Good for single-page tools today; multi-file
          projects come with the in-browser IDE.
        </p>
            ...
            <div className="flex items-center justify-between border-b border-line bg-paper-dim/60 px-4 py-2">
              ...
              {code && !loading && (
                <div className="flex items-center gap-3">
                  {provider && (
                    <span className="font-mono text-[11px] text-ink-soft">via {provider}</span>
                  )}
