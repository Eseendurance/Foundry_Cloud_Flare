...
const entries: Entry[] = [
  ...
  },
  {
    status: "live",
    name: "AI app builder",
    note: "Describe an app, get back a real running single-page app, generated live by Claude.",
  },
  {
    status: "live",
  ...
  },
  {
    ...
    note: "Real SMTP sending once you connect an account, plus a live SPF/DMARC domain checker that needs no key at all.",
  },
  {
    status: "live",
    name: "Domain lookup",
